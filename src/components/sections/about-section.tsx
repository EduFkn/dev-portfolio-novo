    ...
    <section id="about" className="bg-card/10 animate-fade-in-up-subtle">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 items-start">
          {/* Card 1: Name & Intro */}
          <Card className="lg:col-span-2 bg-card shadow-custom-dark hover:shadow-custom-hover-dark transition-shadow duration-300 animate-fade-in-up-subtle h-full">
            <CardHeader>
          ...
          <Card className="lg:col-span-1 bg-card shadow-custom-dark hover:shadow-custom-hover-dark transition-shadow duration-300 animate-fade-in-up-subtle h-full" style={{ animationDelay: '0.2s' }}>
            <CardHeader>
          ...
          <Card className="lg:col-span-2 bg-card shadow-custom-dark hover:shadow-custom-hover-dark transition-shadow duration-300 animate-fade-in-up-subtle h-full" style={{ animationDelay: '0.3s' }}>
            <CardHeader>
              <CardTitle className="font-headline text-lg sm:text-xl text-accent flex items-center">
