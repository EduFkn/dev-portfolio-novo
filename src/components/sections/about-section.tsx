    ...
    <section id="about" className="bg-background/10 animate-fade-in-up-subtle">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
          ...
          {/* Card 4: Map */}
          <Card 
            className="md:col-span-2 bg-card shadow-custom-dark hover:shadow-custom-hover-dark transition-shadow duration-300 animate-fade-in-up-subtle min-h-[300px] md:min-h-[350px] lg:min-h-[400px] overflow-hidden" 
