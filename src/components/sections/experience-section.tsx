...
export function ExperienceSection() {
  ...
  return (
    <section id="experience" className="py-12 md:py-20 animate-fade-in-up-subtle">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative space-y-10 md:space-y-12">
          ...
          {experienceData.map((exp, index) => (
            <div key={index} className="relative flex items-start group pl-8 md:pl-0 animate-fade-in-up-subtle" style={{ animationDelay: `${0.2 + index * 0.1}s` }}>
              {/* Timeline dot */}
