...
const TestimonialCard = ({ testimonial }: { testimonial: ReturnType<typeof getTestimonialsData>[0] }) => (
  <Card className="w-[260px] sm:w-[280px] md:w-[300px] h-full flex flex-col bg-card shadow-lg hover:shadow-custom-hover-dark transition-all duration-300 mx-3 shrink-0">
