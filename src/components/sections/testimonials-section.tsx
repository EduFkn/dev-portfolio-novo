...
const getTestimonialsData = (t: Function) => [
  {
    ...
    avatarUrl: "https://placehold.co/80x80/6A0DAD/FFFFFF.png?text=AS", // Purple theme
    rating: 5,
  ...
  },
  {
    ...
    avatarUrl: "https://placehold.co/80x80/A020F0/FFFFFF.png?text=CO", // Bright Purple
    rating: 5,
  ...
  },
  {
    ...
    avatarUrl: "https://placehold.co/80x80/8A2BE2/FFFFFF.png?text=JS", // Blue Violet
    rating: 4,
  ...
  },
  {
    ...
    avatarUrl: "https://placehold.co/80x80/4B0082/E6E6FA.png?text=RM", // Indigo, Lavender text
    rating: 5,
  ...
  },
  {
    ...
    avatarUrl: "https://placehold.co/80x80/9932CC/FFFFFF.png?text=BC", // Dark Orchid
    rating: 5,
  ...
  },
  {
    ...
    avatarUrl: "https://placehold.co/80x80/7F00FF/FFFFFF.png?text=FL", // Violet
    rating: 4,
...
const TestimonialCard = ({ testimonial }: { testimonial: ReturnType<typeof getTestimonialsData>[0] }) => (
  <Card className="w-[260px] sm:w-[300px] md:w-[320px] h-full flex flex-col bg-card shadow-lg hover:shadow-custom-hover-dark transition-all duration-300 mx-3 shrink-0">
    <CardContent className="p-4 md:p-5 flex flex-col items-center text-center flex-grow">
      <div className="relative w-14 h-14 md:w-16 md:h-16 mb-2.5 rounded-full overflow-hidden border-2 border-primary">
        <Image
      ...
      <h3 className="text-sm md:text-base font-semibold text-accent">{testimonial.name}</h3>
